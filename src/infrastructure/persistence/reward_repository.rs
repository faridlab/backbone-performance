...
//!
//! Thin newtype over `backbone_orm::GenericCrudRepository<Reward, backbone_orm::SoftDelete>`.
...
/// Table name for Reward entities
pub const TABLE_NAME: &str = "performance.rewards";
...
backbone_core::impl_crud_repository!(RewardRepository, Reward, soft_delete);
