...
//! For custom behaviour, create `feedback_service_custom.rs` (preserved on regen).
...
///
/// Custom extensions go in `feedback_service_custom.rs`:
///
/// ```rust,ignore
/// pub struct FeedbackServiceCustom {
///     inner: Arc<FeedbackService>,
