//! Specifications for Appraisal aggregate
//!
...
// Each predicate implements `Specification<Appraisal>` and can be combined
...
//
// pub struct ActiveAppraisalSpec;
// impl Specification<Appraisal> for ActiveAppraisalSpec {
//     fn is_satisfied_by(&self, e: &Appraisal) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
