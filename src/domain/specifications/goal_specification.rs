//! Specifications for Goal aggregate
//!
...
// Each predicate implements `Specification<Goal>` and can be combined
...
//
// pub struct ActiveGoalSpec;
// impl Specification<Goal> for ActiveGoalSpec {
//     fn is_satisfied_by(&self, e: &Goal) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
