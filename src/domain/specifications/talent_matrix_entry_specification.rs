//! Specifications for TalentMatrixEntry aggregate
//!
...
// Each predicate implements `Specification<TalentMatrixEntry>` and can be combined
...
//
// pub struct ActiveTalentMatrixEntrySpec;
// impl Specification<TalentMatrixEntry> for ActiveTalentMatrixEntrySpec {
//     fn is_satisfied_by(&self, e: &TalentMatrixEntry) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
