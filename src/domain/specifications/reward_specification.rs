//! Specifications for Reward aggregate
//!
...
// Each predicate implements `Specification<Reward>` and can be combined
...
//
// pub struct ActiveRewardSpec;
// impl Specification<Reward> for ActiveRewardSpec {
//     fn is_satisfied_by(&self, e: &Reward) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
