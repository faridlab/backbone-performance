//! Specifications for AppraisalCycle aggregate
//!
...
// Each predicate implements `Specification<AppraisalCycle>` and can be combined
...
//
// pub struct ActiveAppraisalCycleSpec;
// impl Specification<AppraisalCycle> for ActiveAppraisalCycleSpec {
//     fn is_satisfied_by(&self, e: &AppraisalCycle) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
