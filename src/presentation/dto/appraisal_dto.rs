...
impl PatchAppraisalDto {
    ...
    pub fn has_changes(&self) -> bool {
        self.company_id.is_some() || self.employee_id.is_some() || self.cycle_id.is_some() || self.reviewer_id.is_some() || self.status.is_some() || self.overall_rating.is_some() || self.submitted_at.is_some()
    }
}
